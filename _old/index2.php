  ...
  <html>
    <head>
      ...
      <meta name="description" content="Viaja a Islas Maldivas y descubre cómo puedes ayudar a combatir la contaminación de plásticos en nuestros océanos.">
		...
		<link type="text/css" rel="stylesheet" href="assets/css/corona2.css?v=1.9"  media="screen,projection"/>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 center-align">
                <h6><a href="Corona_Voluntarios_por_el_Oceano_bases_concurso_2017_v4.pdf" target="_blank" class="white-text">bases legales</a> <!-- · <a href="javascript:void(0);" target="_blank" class="white-text">términos y condiciones</a> --> · <a href="faq.php" target="_blank" class="white-text">PREGUNTAS FRECUENTES</a></h6>
