...
function fbs_click() {
	u = location.href;
	t=document.title;
	window.open('http://www.facebook.com/sharer.php?u=http://voluntariosporeloceano.cl/&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=626,height=436');
	return false;
}
...
function tw_click() {
	u=location.href;
	t=document.title;
	window.open('https://twitter.com/intent/tweet?text=http://voluntariosporeloceano.cl/&hashtags=VoluntariosPorElOceano','sharer','toolbar=0,status=0,width=626,height=436');
	return false;
}
...
$('.sharefb').on('click', function(){
	...
	window.open('http://www.facebook.com/sharer.php?u=http://voluntariosporeloceano.cl?videoID='+video+'&t='+encodeURIComponent(t),'sharer','toolbar=0,status=0,width=626,height=436');
	return false;
});
...
$('.sharetw').on('click', function(){
	u=location.href;
	t=document.title;
	window.open('https://twitter.com/intent/tweet?text=http://voluntariosporeloceano.cl?videoID='+video+'&hashtags=VoluntariosPorElOceano','sharer','toolbar=0,status=0,width=626,height=436');
	return false;
});
