					...
					<div class="col s12">
						<div class="row" style="margin-bottom: 0;">
							<div class="col s12" data-scroll-speed="3">
								<h1>¡AYÚDANOS A ELEGIR A LOS 4 VOLUNTARIOS POR EL OCÉANO!</h1>
							</div>
						</div>	
						<div class="row">
							<div class="col m8 offset-m2"data-scroll-speed="4">
								<p class="animated fadeIn">ENTRE LOS MÁS DE 12.000 POSTULANTES, YA TENEMOS A LOS 12 FINALISTAS QUE ESPERAN SER UNO DE LOS 4 QUE VIAJARÁN A ISLAS MALDIVAS.<br>¡VOTA POR TU FAVORITO!</p>
															</div>
						</div>						
					</div>
				</div>
