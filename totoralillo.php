			...
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Totoralillo</h3>
							<h2>IV REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Totoralillo.<br>
				...
				<div class="col s12 m10 offset-m1 center-align">		
					<div class="voluntario">
						<img src="assets/galerias/totoralillo/01.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/totoralillo/02.jpg" class="voluntarios-img">
					</div>
