    ...
    <body class="voluntarios">
    	...
    	<div class="container" id="galerias">
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Maitencillo</h3>
							<h2>V REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Maitencillo.<br>
				...
				<?php
				if ($handle = opendir('assets/galerias/maitencillo')) {
				    ...
				    while (false !== ($entry = readdir($handle))) {
						...
						<img src="assets/galerias/maitencillo/<?php echo $entry;?>" class="voluntarios-img">
					</div>
				        <?php
				        }
				    }
