    ...
    <body class="voluntarios">
    	...
    	<div class="container" id="galerias">
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Pichilemu</h3>
							<h2>VI REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Pichilemu.<br>
				...
				<?php
				if ($handle = opendir('assets/galerias/pichilemu')) {
				    ...
				    while (false !== ($entry = readdir($handle))) {
						...
						<img src="assets/galerias/pichilemu/<?php echo $entry;?>" class="voluntarios-img">
					</div>
				        <?php
				        }
				    }
