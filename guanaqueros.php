			...
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Guanaqueros</h3>
							<h2>IV REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Guanaqueros.<br>
				...
				<div class="col s12 m10 offset-m1 center-align">		
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/01.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/02.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/03.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/04.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/05.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/06.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/07.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/08.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/09.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/10.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/guanaqueros/11.jpg" class="voluntarios-img">
					</div>
