			...
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Bahía Inglesa</h3>
							<h2>XV REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Bahía Inglesa.<br>
				...
				<div class="col s12 m10 offset-m1 center-align">		
					<div class="voluntario">
						<img src="assets/galerias/bahia/01.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/bahia/02.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/bahia/03.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/bahia/04.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/bahia/05.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/bahia/06.jpg" class="voluntarios-img">
					</div>
