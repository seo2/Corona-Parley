    ...
    <body class="voluntarios">
    	...
    	<div class="container" id="galerias">
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>Puertecillo y Matanza</h3>
							<h2>VI REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Puertecillo y Matanza.<br>
				...
				<?php
				if ($handle = opendir('assets/galerias/puertecillo')) {
					$files = array();	
				    ...
				    foreach ($files as $file) {
						...
						<img src="assets/galerias/puertecillo/<?php echo $file;?>" class="voluntarios-img">
					</div>
				        <?php
				        }
