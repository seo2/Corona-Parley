			...
			<div class="row animated fadeInDown">
				<div class="col s12 m8 offset-m2 center-align">
					<div class="row">
						<div class="col s12 center-align">
							<h1>ARICA</h3>
							<h2>XV REGIÓN</h2>
							<p>Ya terminamos las limpiezas de las playas de Arica.<br>
				...
				<div class="col s12 m10 offset-m1 center-align">		
					<div class="voluntario">
						<img src="assets/galerias/arica/01.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/02.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/03.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/04.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/05.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/06.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/07.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/08.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/09.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/10.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/11.jpg" class="voluntarios-img">
					</div>
					<div class="voluntario">
						<img src="assets/galerias/arica/12.jpg" class="voluntarios-img">
					</div>
